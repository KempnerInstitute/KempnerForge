...
- **VLM evaluation moved out of core into `examples/vlm-evaluation/`** (modeled on `examples/qwen3_vlm/`: README-documented, standalone, unpackaged). Text eval is unchanged.
