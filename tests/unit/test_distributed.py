...
class TestBuildParallelModelVLM:
    ...
    def test_video_build_attaches_frame_time_embed(self):
        """frames_per_clip>1 with an explicit [time_embedding] routes through
        _build_vlm and attaches a FrameTimeEmbedding, built + materialized + cast
        on the device_mesh=None (no-FSDP) path."""
